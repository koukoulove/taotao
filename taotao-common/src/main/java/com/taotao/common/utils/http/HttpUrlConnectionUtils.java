...
public abstract class HttpUrlConnectionUtils {
    ...
    public static void main(String[] args) {
        try {
//            String doGet = HttpUrlConnectionUtils.doGet("http://crowdfund.taijs.com/crowdfund_web/v1/crowdfund/productpagelist.json");
//            System.out.println(doGet);
            
            HttpGet get = new HttpGet("https://114.55.137.252/fund-app/consumerFinance/v1/validateTokenAndMobile?token=123&mobile=123213");
            CloseableHttpClient httpClient = HttpClients.createDefault();
            CloseableHttpResponse rep = httpClient.execute(get);
            System.out.println(EntityUtils.toString(rep.getEntity(), "UTF-8"));
